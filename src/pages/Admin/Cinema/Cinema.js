...
export default function Cinema(props) {
  ...
  const columns = [
        ...
        return (
          <div
            style={{
              ...
              backgroundImage: `url(${DOMAIN_STATIC_FILE}${rap.logo})`,
            }}
          >
            <img
    ...
    },
    {
      ...
      dataIndex: "name",
      render: (text, rap) => {
        return <p>{_.truncate(rap.name, { length: "30", separator: "." })}</p>;
      },
      width: "15%",
    },
    {
    ...
    },
    {
      ...
      render: (text, rap) => {
        return (
          <p>{_.truncate(rap.address, { length: "40", separator: "." })}</p>
        );
      },
      width: "25%",
      key: "tenPhim",
  ...
  return (
    <div className="mt-5">
      ...
      <div className="my-3 mx-10 flex justify-between">
        <Button
          onClick={() => {
            history.push("/Admin/Cinemas/Create");
          }}
        >
